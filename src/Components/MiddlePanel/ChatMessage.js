...
export default function ChatMessage({ data, UserData }) {
  ...
  return (
    <div
      className={
        outbound ? 'ChatMessageContainerOutbound' : 'ChatMessageContainer'
      }
    >
      <div className={outbound ? 'ChatMessageOutbound' : 'ChatMessage'}>
        ...
        >
          <div
            className={outbound ? 'ChatMessageBodyOutbound' : 'ChatMessageBody'}
          >
            <div>{data.body}</div>
          </div>
        </div>
        <div
          className={
            outbound ? 'ChatMessageSenderOutbound' : 'ChatMessageSender'
          }
        >
        ...
        <div>
          <img
            className={
              outbound ? 'ChatMessageImageOutbound' : 'ChatMessageImage'
            }
