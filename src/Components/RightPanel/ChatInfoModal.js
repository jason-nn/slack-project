      ...
      {DisplayChatInfoModal ? (
        <div className="Modal">
          <div>
            ...
            <div className="ChatName">Invite a user to {DisplayChatName}</div>
            ...
            <form
              onSubmit={(e) => {
                ...
                const index = uids.findIndex((uid) => uid === inviteUser);
                ...
                if (index > -1) {
                  ...
                  if (index2 === -1) {
                    ...
                    axios(Config.PostAddMember(data, UserHeaders))
                      .then((response) => {
                        axios(
                          Config.GetChannelMembers(DisplayChatID, UserHeaders)
                        )
                          .then((response) => {
                            setChannelMembers(
